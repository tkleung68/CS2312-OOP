import java.util.*;		//like include

public class Main	//main method where method means function
{
   public static void main(String[] args)
   {
	   ...
	   Scanner scannerObj = new Scanner(System.in);	// crate a obj under scanner
	   int y, m, d;
